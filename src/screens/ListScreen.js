...
export default function SobreScreen() {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Image
        source={{ uri: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=800' }}
        style={styles.image}
      />
      <View style={styles.body}>
        ...
        <Text style={styles.text}>
          O Guia Turístico Digital foi desenvolvido para ajudar visitantes a explorar os melhores
          destinos, monumentos, museus e restaurantes de Londres.
        </Text>
        <Text style={styles.text}>
          Nosso objetivo é tornar a experiência turística mais rica, organizada e acessível, reunindo
          informações confiáveis e atualizadas em um único aplicativo.
        </Text>
